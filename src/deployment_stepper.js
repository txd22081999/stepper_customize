...
const useStyles = makeStyles((theme, props) => ({
  ...
  stepContent: {
    borderLeft: props => {
      ...
      var visible = true;
      if (props.steps && props.activeStep === props.steps.length - 1) {
        visible = false;
        return "0px solid #FFFFFF";
        //true ? "5px solid #CCC" : "0px solid #FFFFFF"
      } else {
        return "5px solid #CCC";
      }

      //(props.steps && props.activeStep < props.steps.length ) ? "5px solid #CCC" : "0px solid #FFFFFF"
    }
  }
}));
